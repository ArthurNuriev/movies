...
import {genreScienceFictionService} from "../../../services/genreScienceFictionService";

const ScienceFictionList = () => {

    const numOfPage = useParams();
    const [movies, setMovies] = useState([]);
    const [path] = useState(URLS.genreScienceFiction);
    ...
    useEffect(() => {
        genreScienceFictionService.getPage(numOfPage.page).then(({data}) => {
