...
import {genreThrillerService} from "../../../services/genreThrillerService";

const ThrillerList = () => {

    const numOfPage = useParams();
    const [movies, setMovies] = useState([]);
    const [path] = useState(URLS.genreThriller);
    ...
    useEffect(() => {
        genreThrillerService.getPage(numOfPage.page).then(({data}) => {
